...
extension AiFeatureGroupX on AiFeatureGroup {
  ...
  String get subtitle {
    return switch (this) {
      AiFeatureGroup.rewrite => 'Viết lại theo phong cách tự nhiên, chuyên nghiệp, ngắn gọn, lịch sự...',
      AiFeatureGroup.grammar => 'Sửa lỗi chính tả, ngữ pháp, câu thiếu tự nhiên, giữ nguyên ý nghĩa.',
      AiFeatureGroup.summary => 'Rút gọn đoạn văn dài thành tóm tắt ngắn, ý chính, todo list.',
      AiFeatureGroup.translate => 'Dịch Việt <-> Anh hoặc tự động nhận diện ngôn ngữ.',
      AiFeatureGroup.smartReply => 'Tạo câu trả lời phù hợp (Đồng ý, Từ chối lịch sự, Yêu cầu thêm thông tin...).',
      AiFeatureGroup.generate => 'Soạn email, tin nhắn, bài đăng, mô tả, danh sách công việc...',
      AiFeatureGroup.qa => 'Đặt câu hỏi trực tiếp về ý nghĩa, giải pháp hoặc hướng xử lý của đoạn văn.',
      AiFeatureGroup.codeExplain => 'Giải thích code, phân tích log lỗi, gợi ý nguyên nhân & sửa lỗi.',
      AiFeatureGroup.extractInfo => 'Trích xuất Tên, SĐT, Email, Ngày tháng, Link ra dạng JSON / Bảng.',
      AiFeatureGroup.titlesTags => 'Tạo tiêu đề ngắn, từ khóa tìm kiếm, thẻ phân loại collection.',
      AiFeatureGroup.classify => 'Tự động nhận diện nhóm: Công việc, Cá nhân, Code, Email, Mua sắm...',
      AiFeatureGroup.ocrRefine => 'Làm sạch lỗi nhận dạng OCR, sửa chính tả và tóm tắt văn bản từ ảnh.',
    };
  }
  ...
  IconData get icon {
    return switch (this) {
      ...
      AiFeatureGroup.codeExplain => CupertinoIcons.chevron_left_slash_chevron_right,
