...
- **Local SQLite Database**: All copied items (text, images, links, snippets, colors, files) are stored exclusively in an encrypted/protected local SQLite database located within your macOS sandbox/app data directory (`~/Library/Application Support/com.clipflow.app`).
