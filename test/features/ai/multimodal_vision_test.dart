...
void main() {
  group('Multimodal Vision Inference', () {
    test(
      'AiModelInfo supports multimodal vision flags and mmproj projections',
      () {
        const visionModel = AiModelInfo(
          id: 'gemma-4-12b-vision',
          name: 'Gemma 4 12B Multimodal Vision',
          description:
              'Google Gemma 4 vision model capable of direct image pixel inspection.',
          parameterSize: '12B',
          fileSizeMb: 7500,
    ...
    test(
      'LocalAiEngine constructs multimodal context combining pixels and OCR secondary text',
      () {
