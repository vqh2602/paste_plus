...
''';
    ...
    test('verifyModelChecksum rejects files with mismatched content', () async {
      ...
      final correctHash = crypto.sha256.convert(utf8.encode('correct content')).toString();
      ...
      expect(await service.verifyModelChecksum(corruptFile, correctHash), isFalse);
    ...
    test('LocalAiEngine prompt wraps context with dynamic nonce delimiter, not static tags', () {
