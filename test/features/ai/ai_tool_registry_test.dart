...
void main() {
  ...
  group('AiToolRegistry', () {
    ...
    test(
      'mutating tool requests confirmation and respects cancellation',
      () async {
        var confirmationRequested = false;
    ...
    test(
      'mutating tool is blocked (fail-closed) when no confirmation callback provided',
      () async {
